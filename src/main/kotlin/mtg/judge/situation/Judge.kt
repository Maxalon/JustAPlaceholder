    ...
    private fun apply(e: EventSpec, state: GameState, engine: Engine) {
        ...
        when (e.verb.lowercase()) {
            ...
            "ask" -> {
                ...
                if (e.to == "tokenMade") {
                    val name = e.card?.name ?: throw JudgeException("ask needs a card"); val p = state.player(e.player ?: "me")
