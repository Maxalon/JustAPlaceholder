...
class NameIndex private constructor(private val byNorm: Map<String, Entry>, val maxWords: Int, private val heads: Map<String, List<Entry>> = emptyMap()) {
    ...
    companion object {
        ...
        private val commonWords = setOf("the", "a", "an", "of", "end", "start", "beginning", "turn", "step", "phase", "time", "game", "play", "attacking", "blocking", "wear", "tear", "begin", "hit", "run", "swing", "bolt", "away", "far", "right", "left", "return", "never", "deal", "deals", "damage", "take", "takes", "gain", "gains", "lose", "loses", "die", "dies", "survive", "trigger", "resolve", "work", "happen", "count", "still", "get", "gets", "win", "wins", "keep", "come", "back", "go", "goes", "stay", "stays", "does", "do", "did", "will", "would", "can", "could", "should",
